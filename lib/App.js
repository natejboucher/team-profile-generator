...
App.prototype.addEngineer = function() {
    inquirer
        ...
        .then(response => {
            this.engineers.push(new Engineer(response.name, response.id, response.email, response.github));
            this.addTeamMember();
        })
}
...
App.prototype.addIntern = function() {
    inquirer
        ...
        .then(response => {
            this.interns.push(new Intern(response.name, response.id, response.email, response.school));
            this.addTeamMember();
        })
}
